    ...
    <main className="container">
      ...
      <div className="features">
        <div className="feature-card">
          <div className="icon">ÃÂ°ÃÂÃÂ¤ÃÂ</div>
          <h2>Claude AI</h2>
          <p>Powered by Anthropic's Claude, providing intelligent code assistance and natural language understanding.</p>
          <a href="https://claude.ai/" target="_blank" rel="noopener noreferrer" className="feature-link">Visit Claude ÃÂ¢ÃÂÃÂ</a>
        </div>

        <div className="feature-card">
          <div className="icon">ÃÂ¢ÃÂÃÂ¡</div>
          <h2>Next.js 15</h2>
          <p>Built with the latest Next.js App Router for optimal performance and modern React features.</p>
          <a href="https://nextjs.org/" target="_blank" rel="noopener noreferrer" className="feature-link">Visit Next.js ÃÂ¢ÃÂÃÂ</a>
        </div>
        ...
        <div className="feature-card">
          ...
          <a href="https://e2b.dev/docs" target="_blank" rel="noopener noreferrer" className="feature-link">Visit E2B ÃÂ¢ÃÂÃÂ</a>
        </div>
