...
export async function GET(
   ...
   try {
      ...
      const maintenanceDueProjection =
         await prisma.maintenanceDueProjection.findUnique({
            where: {
               id: params.id,
            },
         });
               ...
               OR: [
                  {
                     scheduled_maintenance_id:
                        maintenanceDueProjection.scheduled_maintenance_id,
                  },
                  {
                     unscheduled_maintenance_id:
                        maintenanceDueProjection.unscheduled_maintenance_id,
                  },
               ],
            },
         },
